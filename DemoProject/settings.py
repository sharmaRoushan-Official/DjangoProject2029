...
SECRET_KEY = 'django-insecure-n$o8y927^y!+-$2x1f!=*1fj3eewa&mwp8_(!(u^jhv5enzt%h'
...
INSTALLED_APPS = [
    ...
    "demoAPI", # this is your app name here which you created demoAPI
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'static' # Now i have defined static ROOT
